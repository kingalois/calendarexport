package at.am.googlecalendar.connection;
...
/**
 * Class handle the authorization to the google api to access the calendar
 * 
 * @author alois muehleder
 *
 */
public class GoogleCalendarConnector {
	...
	/** Application name. */
	private static final String APPLICATION_NAME = "Google Calendar Export";
	...
	static {
		try {
			HTTP_TRANSPORT = new NetHttpTransport();// GoogleNetHttpTransport.newTrustedTransport();
	...
	public static Credential authorize() throws IOException {
		...
		log.info("path of secrets: " + f.getAbsolutePath());
		if(!f.exists()){
			throw new IOException("client_secret.json file does not exist: " + f.getAbsolutePath());
		}
